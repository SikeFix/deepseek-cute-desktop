(() => {
  ...
  style.textContent = `
    ...
    .dsm-update-pill:hover { background:rgba(85,216,194,.18); }
  ...
  bar.innerHTML = `
    <span class="dsm-windows-brand">DeepSeek Cute <button class="dsm-update-pill" data-state="idle" title="点击检查更新">检查更新</button></span>
